...
{{-- <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white"> --}}
    <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
        ...
        <h1>{{__('frontpage.Documentation')}}</h1>
        <div>
            ...
            <x-dropdown-link :href="route('localization', $locale)"><button>
                {{ $displayName }}
            </button></x-dropdown-link>
          @endforeach

            {{-- <button><a href="/en">English</a></button>
            <button><a href="/sn">Sinhala</a></button>
            <button><a href="/tm">Tamil</a></button> --}}
        </div>
    </div>
</div>
