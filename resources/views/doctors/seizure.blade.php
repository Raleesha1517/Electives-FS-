            ...
            <div class="col-md-12" >
                <div class="card" style="
                  ...
                  {{-- linear-gradient(to top, #91c7e3, #ffffff) --}}
                    ...
                    <div class="card-body">
                        <form method="POST" action="/doctors/records">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-10 offset-sm-2">
                                    ...
                                    style="background-color: #3fafa0; color:#ffffff; border: none" id="sinhala">
                                        {{ __('common.Submit') }}
                                    </button>
                                    <button type="reset" class="btn btn-secondary" id="sinhala"> {{ __('common.Reset') }}</button>
                                    <a href="/doctors/patients/{{ $patient->id }}" class="btn btn-primary"
                                    style="background-color: #3fafa0; color:#ffffff; border: none" id="sinhala">{{__('common.Back')}}</a>
                                </div>
                            </div>
