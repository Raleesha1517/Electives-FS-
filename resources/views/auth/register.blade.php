                    ...
                    <div class="card-body">
                      ...
                      <form method="POST" action="{{ route('register') }}" class="row g-3 needs-validation" >
                        ...
                        <div class="col-12">
                          ...
                          <input type="email" name="email" class="form-control" id="yourEmail" value="{{ old('email') }}" required autocomplete="email">
                          <div class="invalid-feedback">
                              @error('email')
                                  {{ $message }}
                              @enderror
                        ...
                        <div class="col-12">
                          <button class="btn custombtn w-100" type="submit">Create Account</button>
                        </div>
                        <div class="col-12">
